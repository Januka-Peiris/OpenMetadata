...
public class CreateMlModelService implements CreateEntity
{
    ...
    @JsonPropertyDescription("Display Name that identifies this mlModel service.")
     ...
     */
    @JsonProperty("domain")
    @JsonPropertyDescription("Fully qualified name of the domain the MLModel Service belongs to.")
    ...
    public CreateMlModelService withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateMlModelService withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public CreateMlModelService withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public CreateMlModelService withServiceType(CreateMlModelService.MlModelServiceType serviceType) {
        this.serviceType = serviceType;
        return this;
    }
    ...
    public CreateMlModelService withConnection(MlModelConnection connection) {
        this.connection = connection;
        return this;
    }
    ...
    public CreateMlModelService withTags(List<TagLabel> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public CreateMlModelService withOwner(EntityReference owner) {
        this.owner = owner;
        return this;
    }
    ...
    public CreateMlModelService withDataProducts(List<String> dataProducts) {
        this.dataProducts = dataProducts;
        return this;
    }
    ...
    public CreateMlModelService withDomain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CreateMlModelService.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CreateMlModelService) == false) {
            return false;
        }
        CreateMlModelService rhs = ((CreateMlModelService) other);
     ...
     */
    @Generated("jsonschema2pojo")
    public enum MlModelServiceType
        implements EnumInterface
    {
        ...
        private final static Map<String, CreateMlModelService.MlModelServiceType> CONSTANTS = new HashMap<String, CreateMlModelService.MlModelServiceType>();

        static {
            for (CreateMlModelService.MlModelServiceType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        MlModelServiceType(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static CreateMlModelService.MlModelServiceType fromValue(String value) {
            CreateMlModelService.MlModelServiceType constant = CONSTANTS.get(value);
            if (constant == null) {
