...
public class CreateMessagingService implements CreateEntity
{
     ...
     */
    @JsonProperty("tags")
    @JsonPropertyDescription("Tags for this Messaging Service.")
    @Valid
     ...
     */
    @JsonProperty("domain")
    @JsonPropertyDescription("Fully qualified name of the domain the Messaging Service belongs to.")
    ...
    public CreateMessagingService withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateMessagingService withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public CreateMessagingService withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public CreateMessagingService withServiceType(CreateMessagingService.MessagingServiceType serviceType) {
        this.serviceType = serviceType;
        return this;
    }
    ...
    public CreateMessagingService withConnection(MessagingConnection connection) {
        this.connection = connection;
        return this;
    }
    ...
    public CreateMessagingService withTags(List<TagLabel> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public CreateMessagingService withOwner(EntityReference owner) {
        this.owner = owner;
        return this;
    }
    ...
    public CreateMessagingService withDataProducts(List<String> dataProducts) {
        this.dataProducts = dataProducts;
        return this;
    }
    ...
    public CreateMessagingService withDomain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CreateMessagingService.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CreateMessagingService) == false) {
            return false;
        }
        CreateMessagingService rhs = ((CreateMessagingService) other);
        ...
        implements EnumInterface
    {
        ...
        private final static Map<String, CreateMessagingService.MessagingServiceType> CONSTANTS = new HashMap<String, CreateMessagingService.MessagingServiceType>();

        static {
            for (CreateMessagingService.MessagingServiceType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        MessagingServiceType(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static CreateMessagingService.MessagingServiceType fromValue(String value) {
            CreateMessagingService.MessagingServiceType constant = CONSTANTS.get(value);
            if (constant == null) {
