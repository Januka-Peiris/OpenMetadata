...
public class PercentageOfEntitiesWithDescriptionByType implements DataInsightInterface
{
    ...
    public PercentageOfEntitiesWithDescriptionByType withTimestamp(Long timestamp) {
        this.timestamp = timestamp;
        return this;
    }
    ...
    public PercentageOfEntitiesWithDescriptionByType withEntityType(String entityType) {
        this.entityType = entityType;
        return this;
    }
    ...
    public PercentageOfEntitiesWithDescriptionByType withCompletedDescriptionFraction(Double completedDescriptionFraction) {
        this.completedDescriptionFraction = completedDescriptionFraction;
        return this;
    }
    ...
    public PercentageOfEntitiesWithDescriptionByType withCompletedDescription(Double completedDescription) {
        this.completedDescription = completedDescription;
        return this;
    }
    ...
    public PercentageOfEntitiesWithDescriptionByType withEntityCount(Double entityCount) {
        this.entityCount = entityCount;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PercentageOfEntitiesWithDescriptionByType) == false) {
            return false;
        }
        PercentageOfEntitiesWithDescriptionByType rhs = ((PercentageOfEntitiesWithDescriptionByType) other);
        return ((((((this.completedDescription == rhs.completedDescription)||((this.completedDescription!= null)&&this.completedDescription.equals(rhs.completedDescription)))&&((this.entityCount == rhs.entityCount)||((this.entityCount!= null)&&this.entityCount.equals(rhs.entityCount))))&&((this.entityType == rhs.entityType)||((this.entityType!= null)&&this.entityType.equals(rhs.entityType))))&&((this.timestamp == rhs.timestamp)||((this.timestamp!= null)&&this.timestamp.equals(rhs.timestamp))))&&((this.completedDescriptionFraction == rhs.completedDescriptionFraction)||((this.completedDescriptionFraction!= null)&&this.completedDescriptionFraction.equals(rhs.completedDescriptionFraction))));
    }
