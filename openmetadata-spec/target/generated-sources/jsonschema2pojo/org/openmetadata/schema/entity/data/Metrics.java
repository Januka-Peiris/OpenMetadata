...
public class Metrics implements EntityInterface
{
    ...
    @JsonPropertyDescription("Display Name that identifies this metric.")
    ...
    public Metrics withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Metrics withFullyQualifiedName(String fullyQualifiedName) {
        this.fullyQualifiedName = fullyQualifiedName;
        return this;
    }
    ...
    public Metrics withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public Metrics withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public Metrics withVersion(Double version) {
        this.version = version;
        return this;
    }
    ...
    public Metrics withUpdatedAt(Long updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Metrics withUpdatedBy(String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public Metrics withOwner(EntityReference owner) {
        this.owner = owner;
        return this;
    }
    ...
    public Metrics withTags(List<TagLabel> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public Metrics withService(EntityReference service) {
        this.service = service;
        return this;
    }
    ...
    public Metrics withUsageSummary(UsageDetails usageSummary) {
        this.usageSummary = usageSummary;
        return this;
    }
    ...
    public Metrics withChangeDescription(ChangeDescription changeDescription) {
        this.changeDescription = changeDescription;
        return this;
    }
    ...
    public Metrics withDeleted(Boolean deleted) {
        this.deleted = deleted;
        return this;
    }
    ...
    public Metrics withDomain(EntityReference domain) {
        this.domain = domain;
        return this;
    }
    ...
    public Metrics withVotes(Votes votes) {
        this.votes = votes;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((((this.owner == rhs.owner)||((this.owner!= null)&&this.owner.equals(rhs.owner)))&&((this.updatedBy == rhs.updatedBy)||((this.updatedBy!= null)&&this.updatedBy.equals(rhs.updatedBy))))&&((this.changeDescription == rhs.changeDescription)||((this.changeDescription!= null)&&this.changeDescription.equals(rhs.changeDescription))))&&((this.displayName == rhs.displayName)||((this.displayName!= null)&&this.displayName.equals(rhs.displayName))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.fullyQualifiedName == rhs.fullyQualifiedName)||((this.fullyQualifiedName!= null)&&this.fullyQualifiedName.equals(rhs.fullyQualifiedName))))&&((this.version == rhs.version)||((this.version!= null)&&this.version.equals(rhs.version))))&&((this.tags == rhs.tags)||((this.tags!= null)&&this.tags.equals(rhs.tags))))&&((this.deleted == rhs.deleted)||((this.deleted!= null)&&this.deleted.equals(rhs.deleted))))&&((this.service == rhs.service)||((this.service!= null)&&this.service.equals(rhs.service))))&&((this.domain == rhs.domain)||((this.domain!= null)&&this.domain.equals(rhs.domain))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.usageSummary == rhs.usageSummary)||((this.usageSummary!= null)&&this.usageSummary.equals(rhs.usageSummary))))&&((this.votes == rhs.votes)||((this.votes!= null)&&this.votes.equals(rhs.votes))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.href == rhs.href)||((this.href!= null)&&this.href.equals(rhs.href))))&&((this.updatedAt == rhs.updatedAt)||((this.updatedAt!= null)&&this.updatedAt.equals(rhs.updatedAt))));
    }
