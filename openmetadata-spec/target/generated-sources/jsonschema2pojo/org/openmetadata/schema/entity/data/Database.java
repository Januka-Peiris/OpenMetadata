 ...
 * Database
 * <p>
 * This schema defines the Database entity. A database also referred to as Database Catalog is a collection of schemas.@om-entity-type
 * 
 */
...
public class Database implements EntityInterface
{
     ...
     */
    @JsonProperty("tags")
    @JsonPropertyDescription("Tags for this Database.")
    @Valid
     ...
     * 
     */
    @JsonProperty("databaseProfilerConfig")
    @JsonPropertyDescription("This schema defines the type for Database profile config.")
    @Valid
    ...
    public Database withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public Database withFullyQualifiedName(String fullyQualifiedName) {
        this.fullyQualifiedName = fullyQualifiedName;
        return this;
    }
    ...
    public Database withDataProducts(List<EntityReference> dataProducts) {
        this.dataProducts = dataProducts;
        return this;
    }
    ...
    public Database withTags(List<TagLabel> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public Database withVersion(Double version) {
        this.version = version;
        return this;
    }
    ...
    public Database withUpdatedAt(Long updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Database withUpdatedBy(String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public Database withOwner(EntityReference owner) {
        this.owner = owner;
        return this;
    }
    ...
    public Database withService(EntityReference service) {
        this.service = service;
        return this;
    }
    ...
    public Database withServiceType(org.openmetadata.schema.api.services.CreateDatabaseService.DatabaseServiceType serviceType) {
        this.serviceType = serviceType;
        return this;
    }
    ...
    public Database withLocation(EntityReference location) {
        this.location = location;
        return this;
    }
    ...
    public Database withUsageSummary(UsageDetails usageSummary) {
        this.usageSummary = usageSummary;
        return this;
    }
    ...
    public Database withDatabaseSchemas(List<EntityReference> databaseSchemas) {
        this.databaseSchemas = databaseSchemas;
        return this;
    }
    ...
    public Database withChangeDescription(ChangeDescription changeDescription) {
        this.changeDescription = changeDescription;
        return this;
    }
    ...
    public Database withDefault(Boolean _default) {
        this._default = _default;
        return this;
    }
    ...
    public Database withDeleted(Boolean deleted) {
        this.deleted = deleted;
        return this;
    }
    ...
    public Database withRetentionPeriod(String retentionPeriod) {
        this.retentionPeriod = retentionPeriod;
        return this;
    }
    ...
    public Database withExtension(Object extension) {
        this.extension = extension;
        return this;
    }
    ...
    public Database withSourceUrl(String sourceUrl) {
        this.sourceUrl = sourceUrl;
        return this;
    }
    ...
    public Database withDomain(EntityReference domain) {
        this.domain = domain;
        return this;
    }
    ...
    public Database withVotes(Votes votes) {
        this.votes = votes;
        return this;
    }
    ...
    public Database withLifeCycle(LifeCycle lifeCycle) {
        this.lifeCycle = lifeCycle;
        return this;
    }
    ...
    public Database withSourceHash(String sourceHash) {
        this.sourceHash = sourceHash;
        return this;
    }
    ...
    public Database withDatabaseProfilerConfig(DatabaseProfilerConfig databaseProfilerConfig) {
        this.databaseProfilerConfig = databaseProfilerConfig;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Database.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
        ...
        sb.append(',');
        sb.append("databaseSchemas");
        sb.append('=');
        sb.append(((this.databaseSchemas == null)?"<null>":this.databaseSchemas));
        sb.append(',');
        ...
        sb.append(',');
        sb.append("databaseProfilerConfig");
        sb.append('=');
        sb.append(((this.databaseProfilerConfig == null)?"<null>":this.databaseProfilerConfig));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.databaseProfilerConfig == null)? 0 :this.databaseProfilerConfig.hashCode()));
        result = ((result* 31)+((this.databaseSchemas == null)? 0 :this.databaseSchemas.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((((((((((((this.serviceType == rhs.serviceType)||((this.serviceType!= null)&&this.serviceType.equals(rhs.serviceType)))&&((this.extension == rhs.extension)||((this.extension!= null)&&this.extension.equals(rhs.extension))))&&((this.displayName == rhs.displayName)||((this.displayName!= null)&&this.displayName.equals(rhs.displayName))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.sourceUrl == rhs.sourceUrl)||((this.sourceUrl!= null)&&this.sourceUrl.equals(rhs.sourceUrl))))&&((this.databaseProfilerConfig == rhs.databaseProfilerConfig)||((this.databaseProfilerConfig!= null)&&this.databaseProfilerConfig.equals(rhs.databaseProfilerConfig))))&&((this.databaseSchemas == rhs.databaseSchemas)||((this.databaseSchemas!= null)&&this.databaseSchemas.equals(rhs.databaseSchemas))))&&((this.usageSummary == rhs.usageSummary)||((this.usageSummary!= null)&&this.usageSummary.equals(rhs.usageSummary))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.href == rhs.href)||((this.href!= null)&&this.href.equals(rhs.href))))&&((this.updatedAt == rhs.updatedAt)||((this.updatedAt!= null)&&this.updatedAt.equals(rhs.updatedAt))))&&((this.retentionPeriod == rhs.retentionPeriod)||((this.retentionPeriod!= null)&&this.retentionPeriod.equals(rhs.retentionPeriod))))&&((this.owner == rhs.owner)||((this.owner!= null)&&this.owner.equals(rhs.owner))))&&((this._default == rhs._default)||((this._default!= null)&&this._default.equals(rhs._default))))&&((this.updatedBy == rhs.updatedBy)||((this.updatedBy!= null)&&this.updatedBy.equals(rhs.updatedBy))))&&((this.changeDescription == rhs.changeDescription)||((this.changeDescription!= null)&&this.changeDescription.equals(rhs.changeDescription))))&&((this.dataProducts == rhs.dataProducts)||((this.dataProducts!= null)&&this.dataProducts.equals(rhs.dataProducts))))&&((this.fullyQualifiedName == rhs.fullyQualifiedName)||((this.fullyQualifiedName!= null)&&this.fullyQualifiedName.equals(rhs.fullyQualifiedName))))&&((this.version == rhs.version)||((this.version!= null)&&this.version.equals(rhs.version))))&&((this.tags == rhs.tags)||((this.tags!= null)&&this.tags.equals(rhs.tags))))&&((this.sourceHash == rhs.sourceHash)||((this.sourceHash!= null)&&this.sourceHash.equals(rhs.sourceHash))))&&((this.deleted == rhs.deleted)||((this.deleted!= null)&&this.deleted.equals(rhs.deleted))))&&((this.service == rhs.service)||((this.service!= null)&&this.service.equals(rhs.service))))&&((this.domain == rhs.domain)||((this.domain!= null)&&this.domain.equals(rhs.domain))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.location == rhs.location)||((this.location!= null)&&this.location.equals(rhs.location))))&&((this.votes == rhs.votes)||((this.votes!= null)&&this.votes.equals(rhs.votes))))&&((this.lifeCycle == rhs.lifeCycle)||((this.lifeCycle!= null)&&this.lifeCycle.equals(rhs.lifeCycle))));
    }
