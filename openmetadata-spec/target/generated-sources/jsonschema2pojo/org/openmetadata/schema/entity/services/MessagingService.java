...
public class MessagingService implements EntityInterface, ServiceEntityInterface
{
    ...
    @JsonPropertyDescription("Display Name that identifies this messaging service. It could be title or label from the source services.")
     ...
     */
    @JsonProperty("tags")
    @JsonPropertyDescription("Tags for this Message Service.")
    @Valid
    ...
    public MessagingService withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public MessagingService withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public MessagingService withFullyQualifiedName(String fullyQualifiedName) {
        this.fullyQualifiedName = fullyQualifiedName;
        return this;
    }
    ...
    public MessagingService withServiceType(org.openmetadata.schema.api.services.CreateMessagingService.MessagingServiceType serviceType) {
        this.serviceType = serviceType;
        return this;
    }
    ...
    public MessagingService withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public MessagingService withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public MessagingService withConnection(MessagingConnection connection) {
        this.connection = connection;
        return this;
    }
    ...
    public MessagingService withPipelines(List<EntityReference> pipelines) {
        this.pipelines = pipelines;
        return this;
    }
    ...
    public MessagingService withTestConnectionResult(TestConnectionResult testConnectionResult) {
        this.testConnectionResult = testConnectionResult;
        return this;
    }
    ...
    public MessagingService withTags(List<TagLabel> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public MessagingService withVersion(Double version) {
        this.version = version;
        return this;
    }
    ...
    public MessagingService withUpdatedAt(Long updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public MessagingService withUpdatedBy(String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public MessagingService withOwner(EntityReference owner) {
        this.owner = owner;
        return this;
    }
    ...
    public MessagingService withChangeDescription(ChangeDescription changeDescription) {
        this.changeDescription = changeDescription;
        return this;
    }
    ...
    public MessagingService withDeleted(Boolean deleted) {
        this.deleted = deleted;
        return this;
    }
    ...
    public MessagingService withDataProducts(List<EntityReference> dataProducts) {
        this.dataProducts = dataProducts;
        return this;
    }
    ...
    public MessagingService withDomain(EntityReference domain) {
        this.domain = domain;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(MessagingService.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MessagingService) == false) {
            return false;
        }
        MessagingService rhs = ((MessagingService) other);
