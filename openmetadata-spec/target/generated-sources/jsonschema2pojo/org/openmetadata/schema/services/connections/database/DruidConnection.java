...
public class DruidConnection {
    ...
    private DruidConnection.DruidType type = DruidConnection.DruidType.fromValue("Druid");
    /**
    ...
    private DruidConnection.DruidScheme scheme = DruidConnection.DruidScheme.fromValue("druid");
    /**
     * Username
     * <p>
    ...
    @JsonPropertyDescription("Username to connect to Druid. This user should have privileges to read all the metadata in Druid.")
    ...
    @JsonPropertyDescription("Password to connect to Druid.")
    @PasswordField
    ...
    @JsonPropertyDescription("Host and port of the Druid service.")
    @NotNull
     ...
     */
    @JsonProperty("type")
    public DruidConnection.DruidType getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(DruidConnection.DruidType type) {
        this.type = type;
    }

    public DruidConnection withType(DruidConnection.DruidType type) {
        this.type = type;
        return this;
    }
     ...
     */
    @JsonProperty("scheme")
    public DruidConnection.DruidScheme getScheme() {
        return scheme;
    }
     ...
     */
    @JsonProperty("scheme")
    public void setScheme(DruidConnection.DruidScheme scheme) {
        this.scheme = scheme;
    }

    public DruidConnection withScheme(DruidConnection.DruidScheme scheme) {
        this.scheme = scheme;
        return this;
    }
    ...
    public DruidConnection withUsername(String username) {
        this.username = username;
        return this;
    }
    ...
    public DruidConnection withPassword(String password) {
        this.password = password;
        return this;
    }
    ...
    public DruidConnection withHostPort(String hostPort) {
        this.hostPort = hostPort;
        return this;
    }
    ...
    public DruidConnection withDatabaseName(String databaseName) {
        this.databaseName = databaseName;
        return this;
    }
    ...
    public DruidConnection withConnectionOptions(ConnectionOptions connectionOptions) {
        this.connectionOptions = connectionOptions;
        return this;
    }
    ...
    public DruidConnection withConnectionArguments(ConnectionArguments connectionArguments) {
        this.connectionArguments = connectionArguments;
        return this;
    }
    ...
    public DruidConnection withSupportsMetadataExtraction(Boolean supportsMetadataExtraction) {
        this.supportsMetadataExtraction = supportsMetadataExtraction;
        return this;
    }
    ...
    public DruidConnection withSupportsProfiler(Boolean supportsProfiler) {
        this.supportsProfiler = supportsProfiler;
        return this;
    }
    ...
    public DruidConnection withSupportsQueryComment(Boolean supportsQueryComment) {
        this.supportsQueryComment = supportsQueryComment;
        return this;
    }
    ...
    public DruidConnection withSupportsDBTExtraction(Boolean supportsDBTExtraction) {
        this.supportsDBTExtraction = supportsDBTExtraction;
        return this;
    }
    ...
    public DruidConnection withSampleDataStorageConfig(SampleDataStorageConfig sampleDataStorageConfig) {
        this.sampleDataStorageConfig = sampleDataStorageConfig;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DruidConnection.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DruidConnection) == false) {
            return false;
        }
        DruidConnection rhs = ((DruidConnection) other);
        return ((((((((((((((this.supportsMetadataExtraction == rhs.supportsMetadataExtraction)||((this.supportsMetadataExtraction!= null)&&this.supportsMetadataExtraction.equals(rhs.supportsMetadataExtraction)))&&((this.scheme == rhs.scheme)||((this.scheme!= null)&&this.scheme.equals(rhs.scheme))))&&((this.databaseName == rhs.databaseName)||((this.databaseName!= null)&&this.databaseName.equals(rhs.databaseName))))&&((this.supportsProfiler == rhs.supportsProfiler)||((this.supportsProfiler!= null)&&this.supportsProfiler.equals(rhs.supportsProfiler))))&&((this.sampleDataStorageConfig == rhs.sampleDataStorageConfig)||((this.sampleDataStorageConfig!= null)&&this.sampleDataStorageConfig.equals(rhs.sampleDataStorageConfig))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.supportsDBTExtraction == rhs.supportsDBTExtraction)||((this.supportsDBTExtraction!= null)&&this.supportsDBTExtraction.equals(rhs.supportsDBTExtraction))))&&((this.connectionArguments == rhs.connectionArguments)||((this.connectionArguments!= null)&&this.connectionArguments.equals(rhs.connectionArguments))))&&((this.password == rhs.password)||((this.password!= null)&&this.password.equals(rhs.password))))&&((this.connectionOptions == rhs.connectionOptions)||((this.connectionOptions!= null)&&this.connectionOptions.equals(rhs.connectionOptions))))&&((this.hostPort == rhs.hostPort)||((this.hostPort!= null)&&this.hostPort.equals(rhs.hostPort))))&&((this.supportsQueryComment == rhs.supportsQueryComment)||((this.supportsQueryComment!= null)&&this.supportsQueryComment.equals(rhs.supportsQueryComment))))&&((this.username == rhs.username)||((this.username!= null)&&this.username.equals(rhs.username))));
    }
     ...
     */
    @Generated("jsonschema2pojo")
    public enum DruidScheme {

        DRUID("druid");
        private final String value;
        private final static Map<String, DruidConnection.DruidScheme> CONSTANTS = new HashMap<String, DruidConnection.DruidScheme>();

        static {
            for (DruidConnection.DruidScheme c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        DruidScheme(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static DruidConnection.DruidScheme fromValue(String value) {
            DruidConnection.DruidScheme constant = CONSTANTS.get(value);
            if (constant == null) {
    ...
    public enum DruidType {
        ...
        DRUID("Druid");
        private final String value;
        private final static Map<String, DruidConnection.DruidType> CONSTANTS = new HashMap<String, DruidConnection.DruidType>();

        static {
            for (DruidConnection.DruidType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        DruidType(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static DruidConnection.DruidType fromValue(String value) {
            DruidConnection.DruidType constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
