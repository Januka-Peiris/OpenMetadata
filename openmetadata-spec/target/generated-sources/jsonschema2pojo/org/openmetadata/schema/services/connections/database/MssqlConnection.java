...
public class MssqlConnection {
    ...
    private MssqlConnection.MssqlType type = MssqlConnection.MssqlType.fromValue("Mssql");
    /**
    ...
    private MssqlConnection.MssqlScheme scheme = MssqlConnection.MssqlScheme.fromValue("mssql+pytds");
    /**
     * Username
     * <p>
     ...
     */
    @JsonProperty("type")
    public MssqlConnection.MssqlType getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(MssqlConnection.MssqlType type) {
        this.type = type;
    }

    public MssqlConnection withType(MssqlConnection.MssqlType type) {
        this.type = type;
        return this;
    }
     ...
     */
    @JsonProperty("scheme")
    public MssqlConnection.MssqlScheme getScheme() {
        return scheme;
    }
     ...
     */
    @JsonProperty("scheme")
    public void setScheme(MssqlConnection.MssqlScheme scheme) {
        this.scheme = scheme;
    }

    public MssqlConnection withScheme(MssqlConnection.MssqlScheme scheme) {
        this.scheme = scheme;
        return this;
    }
    ...
    public MssqlConnection withUsername(String username) {
        this.username = username;
        return this;
    }
    ...
    public MssqlConnection withPassword(String password) {
        this.password = password;
        return this;
    }
    ...
    public MssqlConnection withHostPort(String hostPort) {
        this.hostPort = hostPort;
        return this;
    }
    ...
    public MssqlConnection withDatabase(String database) {
        this.database = database;
        return this;
    }
    ...
    public MssqlConnection withDriver(String driver) {
        this.driver = driver;
        return this;
    }
    ...
    public MssqlConnection withIngestAllDatabases(Boolean ingestAllDatabases) {
        this.ingestAllDatabases = ingestAllDatabases;
        return this;
    }
    ...
    public MssqlConnection withSupportsMetadataExtraction(Boolean supportsMetadataExtraction) {
        this.supportsMetadataExtraction = supportsMetadataExtraction;
        return this;
    }
    ...
    public MssqlConnection withSupportsDBTExtraction(Boolean supportsDBTExtraction) {
        this.supportsDBTExtraction = supportsDBTExtraction;
        return this;
    }
    ...
    public MssqlConnection withSupportsProfiler(Boolean supportsProfiler) {
        this.supportsProfiler = supportsProfiler;
        return this;
    }
    ...
    public MssqlConnection withSupportsDatabase(Boolean supportsDatabase) {
        this.supportsDatabase = supportsDatabase;
        return this;
    }
    ...
    public MssqlConnection withSupportsUsageExtraction(Boolean supportsUsageExtraction) {
        this.supportsUsageExtraction = supportsUsageExtraction;
        return this;
    }
    ...
    public MssqlConnection withSupportsLineageExtraction(Boolean supportsLineageExtraction) {
        this.supportsLineageExtraction = supportsLineageExtraction;
        return this;
    }
    ...
    public MssqlConnection withSupportsQueryComment(Boolean supportsQueryComment) {
        this.supportsQueryComment = supportsQueryComment;
        return this;
    }
    ...
    public enum MssqlScheme {
        ...
        private final static Map<String, MssqlConnection.MssqlScheme> CONSTANTS = new HashMap<String, MssqlConnection.MssqlScheme>();

        static {
            for (MssqlConnection.MssqlScheme c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        MssqlScheme(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static MssqlConnection.MssqlScheme fromValue(String value) {
            MssqlConnection.MssqlScheme constant = CONSTANTS.get(value);
            if (constant == null) {
    ...
    public enum MssqlType {
        ...
        MSSQL("Mssql");
        private final String value;
        private final static Map<String, MssqlConnection.MssqlType> CONSTANTS = new HashMap<String, MssqlConnection.MssqlType>();

        static {
            for (MssqlConnection.MssqlType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        MssqlType(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static MssqlConnection.MssqlType fromValue(String value) {
            MssqlConnection.MssqlType constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
