...
public class GlueConnection {
    ...
    private GlueConnection.GlueType type = GlueConnection.GlueType.fromValue("Glue");
    /**
     * AWSCredentials
     * <p>
     ...
     */
    @JsonProperty("type")
    public GlueConnection.GlueType getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(GlueConnection.GlueType type) {
        this.type = type;
    }

    public GlueConnection withType(GlueConnection.GlueType type) {
        this.type = type;
        return this;
    }
    ...
    public GlueConnection withAwsConfig(AWSCredentials awsConfig) {
        this.awsConfig = awsConfig;
        return this;
    }
    ...
    public GlueConnection withDatabaseName(String databaseName) {
        this.databaseName = databaseName;
        return this;
    }
    ...
    public GlueConnection withConnectionOptions(ConnectionOptions connectionOptions) {
        this.connectionOptions = connectionOptions;
        return this;
    }
    ...
    public GlueConnection withConnectionArguments(ConnectionArguments connectionArguments) {
        this.connectionArguments = connectionArguments;
        return this;
    }
    ...
    public GlueConnection withSupportsMetadataExtraction(Boolean supportsMetadataExtraction) {
        this.supportsMetadataExtraction = supportsMetadataExtraction;
        return this;
    }
    ...
    public GlueConnection withSupportsDBTExtraction(Boolean supportsDBTExtraction) {
        this.supportsDBTExtraction = supportsDBTExtraction;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GlueConnection.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GlueConnection) == false) {
            return false;
        }
        GlueConnection rhs = ((GlueConnection) other);
        return ((((((((this.supportsMetadataExtraction == rhs.supportsMetadataExtraction)||((this.supportsMetadataExtraction!= null)&&this.supportsMetadataExtraction.equals(rhs.supportsMetadataExtraction)))&&((this.databaseName == rhs.databaseName)||((this.databaseName!= null)&&this.databaseName.equals(rhs.databaseName))))&&((this.awsConfig == rhs.awsConfig)||((this.awsConfig!= null)&&this.awsConfig.equals(rhs.awsConfig))))&&((this.connectionOptions == rhs.connectionOptions)||((this.connectionOptions!= null)&&this.connectionOptions.equals(rhs.connectionOptions))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.supportsDBTExtraction == rhs.supportsDBTExtraction)||((this.supportsDBTExtraction!= null)&&this.supportsDBTExtraction.equals(rhs.supportsDBTExtraction))))&&((this.connectionArguments == rhs.connectionArguments)||((this.connectionArguments!= null)&&this.connectionArguments.equals(rhs.connectionArguments))));
    }
    ...
    public enum GlueType {
        ...
        private final static Map<String, GlueConnection.GlueType> CONSTANTS = new HashMap<String, GlueConnection.GlueType>();

        static {
            for (GlueConnection.GlueType c: values()) {
        ...
        @JsonCreator
        public static GlueConnection.GlueType fromValue(String value) {
            GlueConnection.GlueType constant = CONSTANTS.get(value);
            if (constant == null) {
