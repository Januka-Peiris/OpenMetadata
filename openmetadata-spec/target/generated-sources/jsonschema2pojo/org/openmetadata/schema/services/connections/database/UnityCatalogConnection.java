...
public class UnityCatalogConnection {
    ...
    private UnityCatalogConnection.DatabricksType type = UnityCatalogConnection.DatabricksType.fromValue("UnityCatalog");
    /**
    ...
    private UnityCatalogConnection.DatabricksScheme scheme = UnityCatalogConnection.DatabricksScheme.fromValue("databricks+connector");
    /**
     * Host and Port
     * <p>
     ...
     */
    @JsonProperty("type")
    public UnityCatalogConnection.DatabricksType getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(UnityCatalogConnection.DatabricksType type) {
        this.type = type;
    }

    public UnityCatalogConnection withType(UnityCatalogConnection.DatabricksType type) {
        this.type = type;
        return this;
    }
     ...
     */
    @JsonProperty("scheme")
    public UnityCatalogConnection.DatabricksScheme getScheme() {
        return scheme;
    }
     ...
     */
    @JsonProperty("scheme")
    public void setScheme(UnityCatalogConnection.DatabricksScheme scheme) {
        this.scheme = scheme;
    }

    public UnityCatalogConnection withScheme(UnityCatalogConnection.DatabricksScheme scheme) {
        this.scheme = scheme;
        return this;
    }
    ...
    public UnityCatalogConnection withHostPort(String hostPort) {
        this.hostPort = hostPort;
        return this;
    }
    ...
    public UnityCatalogConnection withToken(String token) {
        this.token = token;
        return this;
    }
    ...
    public UnityCatalogConnection withHttpPath(String httpPath) {
        this.httpPath = httpPath;
        return this;
    }
    ...
    public UnityCatalogConnection withCatalog(String catalog) {
        this.catalog = catalog;
        return this;
    }
    ...
    public UnityCatalogConnection withDatabaseSchema(String databaseSchema) {
        this.databaseSchema = databaseSchema;
        return this;
    }
    ...
    public UnityCatalogConnection withConnectionTimeout(Integer connectionTimeout) {
        this.connectionTimeout = connectionTimeout;
        return this;
    }
    ...
    public UnityCatalogConnection withConnectionOptions(ConnectionOptions connectionOptions) {
        this.connectionOptions = connectionOptions;
        return this;
    }
    ...
    public UnityCatalogConnection withConnectionArguments(ConnectionArguments connectionArguments) {
        this.connectionArguments = connectionArguments;
        return this;
    }
    ...
    public UnityCatalogConnection withSupportsUsageExtraction(Boolean supportsUsageExtraction) {
        this.supportsUsageExtraction = supportsUsageExtraction;
        return this;
    }
    ...
    public UnityCatalogConnection withSupportsLineageExtraction(Boolean supportsLineageExtraction) {
        this.supportsLineageExtraction = supportsLineageExtraction;
        return this;
    }
    ...
    public UnityCatalogConnection withSupportsDBTExtraction(Boolean supportsDBTExtraction) {
        this.supportsDBTExtraction = supportsDBTExtraction;
        return this;
    }
    ...
    public UnityCatalogConnection withSupportsMetadataExtraction(Boolean supportsMetadataExtraction) {
        this.supportsMetadataExtraction = supportsMetadataExtraction;
        return this;
    }
    ...
    public UnityCatalogConnection withSupportsProfiler(Boolean supportsProfiler) {
        this.supportsProfiler = supportsProfiler;
        return this;
    }
    ...
    public UnityCatalogConnection withSupportsDatabase(Boolean supportsDatabase) {
        this.supportsDatabase = supportsDatabase;
        return this;
    }
    ...
    public UnityCatalogConnection withSupportsQueryComment(Boolean supportsQueryComment) {
        this.supportsQueryComment = supportsQueryComment;
        return this;
    }
    ...
    public UnityCatalogConnection withSampleDataStorageConfig(SampleDataStorageConfig sampleDataStorageConfig) {
        this.sampleDataStorageConfig = sampleDataStorageConfig;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(UnityCatalogConnection.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UnityCatalogConnection) == false) {
            return false;
        }
        UnityCatalogConnection rhs = ((UnityCatalogConnection) other);
    ...
    public enum DatabricksScheme {
        ...
        private final static Map<String, UnityCatalogConnection.DatabricksScheme> CONSTANTS = new HashMap<String, UnityCatalogConnection.DatabricksScheme>();

        static {
            for (UnityCatalogConnection.DatabricksScheme c: values()) {
        ...
        @JsonCreator
        public static UnityCatalogConnection.DatabricksScheme fromValue(String value) {
            UnityCatalogConnection.DatabricksScheme constant = CONSTANTS.get(value);
            if (constant == null) {
    ...
    public enum DatabricksType {
        ...
        private final String value;
        private final static Map<String, UnityCatalogConnection.DatabricksType> CONSTANTS = new HashMap<String, UnityCatalogConnection.DatabricksType>();

        static {
            for (UnityCatalogConnection.DatabricksType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static UnityCatalogConnection.DatabricksType fromValue(String value) {
            UnityCatalogConnection.DatabricksType constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
