...
public class SingleStoreConnection {
    ...
    private SingleStoreConnection.SingleStoreType type = SingleStoreConnection.SingleStoreType.fromValue("SingleStore");
    /**
    ...
    private SingleStoreConnection.SingleStoreScheme scheme = SingleStoreConnection.SingleStoreScheme.fromValue("mysql+pymysql");
    /**
     * Username
     * <p>
    ...
    @JsonPropertyDescription("Username to connect to SingleStore. This user should have privileges to read all the metadata in MySQL.")
    @NotNull
    ...
    @JsonPropertyDescription("Password to connect to SingleStore.")
    @PasswordField
    ...
    @JsonPropertyDescription("Host and port of the SingleStore service.")
    @NotNull
     ...
     */
    @JsonProperty("type")
    public SingleStoreConnection.SingleStoreType getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(SingleStoreConnection.SingleStoreType type) {
        this.type = type;
    }

    public SingleStoreConnection withType(SingleStoreConnection.SingleStoreType type) {
        this.type = type;
        return this;
    }
     ...
     */
    @JsonProperty("scheme")
    public SingleStoreConnection.SingleStoreScheme getScheme() {
        return scheme;
    }
     ...
     */
    @JsonProperty("scheme")
    public void setScheme(SingleStoreConnection.SingleStoreScheme scheme) {
        this.scheme = scheme;
    }

    public SingleStoreConnection withScheme(SingleStoreConnection.SingleStoreScheme scheme) {
        this.scheme = scheme;
        return this;
    }
    ...
    public SingleStoreConnection withUsername(String username) {
        this.username = username;
        return this;
    }
    ...
    public SingleStoreConnection withPassword(String password) {
        this.password = password;
        return this;
    }
    ...
    public SingleStoreConnection withHostPort(String hostPort) {
        this.hostPort = hostPort;
        return this;
    }
    ...
    public SingleStoreConnection withDatabaseName(String databaseName) {
        this.databaseName = databaseName;
        return this;
    }
    ...
    public SingleStoreConnection withDatabaseSchema(String databaseSchema) {
        this.databaseSchema = databaseSchema;
        return this;
    }
    ...
    public SingleStoreConnection withConnectionOptions(ConnectionOptions connectionOptions) {
        this.connectionOptions = connectionOptions;
        return this;
    }
    ...
    public SingleStoreConnection withConnectionArguments(ConnectionArguments connectionArguments) {
        this.connectionArguments = connectionArguments;
        return this;
    }
    ...
    public SingleStoreConnection withSupportsMetadataExtraction(Boolean supportsMetadataExtraction) {
        this.supportsMetadataExtraction = supportsMetadataExtraction;
        return this;
    }
    ...
    public SingleStoreConnection withSupportsDBTExtraction(Boolean supportsDBTExtraction) {
        this.supportsDBTExtraction = supportsDBTExtraction;
        return this;
    }
    ...
    public SingleStoreConnection withSupportsProfiler(Boolean supportsProfiler) {
        this.supportsProfiler = supportsProfiler;
        return this;
    }
    ...
    public SingleStoreConnection withSupportsQueryComment(Boolean supportsQueryComment) {
        this.supportsQueryComment = supportsQueryComment;
        return this;
    }
    ...
    public SingleStoreConnection withSampleDataStorageConfig(SampleDataStorageConfig sampleDataStorageConfig) {
        this.sampleDataStorageConfig = sampleDataStorageConfig;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(SingleStoreConnection.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SingleStoreConnection) == false) {
            return false;
        }
        SingleStoreConnection rhs = ((SingleStoreConnection) other);
     ...
     */
    @Generated("jsonschema2pojo")
    public enum SingleStoreScheme {

        MYSQL_PYMYSQL("mysql+pymysql");
        private final String value;
        private final static Map<String, SingleStoreConnection.SingleStoreScheme> CONSTANTS = new HashMap<String, SingleStoreConnection.SingleStoreScheme>();

        static {
            for (SingleStoreConnection.SingleStoreScheme c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        SingleStoreScheme(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static SingleStoreConnection.SingleStoreScheme fromValue(String value) {
            SingleStoreConnection.SingleStoreScheme constant = CONSTANTS.get(value);
            if (constant == null) {
     ...
     */
    @Generated("jsonschema2pojo")
    public enum SingleStoreType {

        SINGLE_STORE("SingleStore");
        private final String value;
        private final static Map<String, SingleStoreConnection.SingleStoreType> CONSTANTS = new HashMap<String, SingleStoreConnection.SingleStoreType>();

        static {
            for (SingleStoreConnection.SingleStoreType c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        SingleStoreType(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static SingleStoreConnection.SingleStoreType fromValue(String value) {
            SingleStoreConnection.SingleStoreType constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
