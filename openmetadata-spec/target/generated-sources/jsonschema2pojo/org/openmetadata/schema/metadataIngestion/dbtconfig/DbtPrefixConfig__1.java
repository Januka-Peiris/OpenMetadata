...
public class DbtPrefixConfig__1 {
    ...
    public DbtPrefixConfig__1 withDbtBucketName(String dbtBucketName) {
        this.dbtBucketName = dbtBucketName;
        return this;
    }
    ...
    public DbtPrefixConfig__1 withDbtObjectPrefix(String dbtObjectPrefix) {
        this.dbtObjectPrefix = dbtObjectPrefix;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DbtPrefixConfig__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DbtPrefixConfig__1) == false) {
            return false;
        }
        DbtPrefixConfig__1 rhs = ((DbtPrefixConfig__1) other);
