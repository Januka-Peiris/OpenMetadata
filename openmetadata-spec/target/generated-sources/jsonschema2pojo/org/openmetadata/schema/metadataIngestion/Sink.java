...
public class Sink {
    ...
    public Sink withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Sink withConfig(ComponentConfig config) {
        this.config = config;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sink.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sink) == false) {
            return false;
        }
        Sink rhs = ((Sink) other);
