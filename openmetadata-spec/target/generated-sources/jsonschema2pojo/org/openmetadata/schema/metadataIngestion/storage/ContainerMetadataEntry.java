...
public class ContainerMetadataEntry {
    ...
    public ContainerMetadataEntry withSeparator(String separator) {
        this.separator = separator;
        return this;
    }
    ...
    public ContainerMetadataEntry withPartitionColumns(List<Column> partitionColumns) {
        this.partitionColumns = partitionColumns;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ContainerMetadataEntry) == false) {
            return false;
        }
        ContainerMetadataEntry rhs = ((ContainerMetadataEntry) other);
        return (((((((this.structureFormat == rhs.structureFormat)||((this.structureFormat!= null)&&this.structureFormat.equals(rhs.structureFormat)))&&((this.isPartitioned == rhs.isPartitioned)||((this.isPartitioned!= null)&&this.isPartitioned.equals(rhs.isPartitioned))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.separator == rhs.separator)||((this.separator!= null)&&this.separator.equals(rhs.separator))))&&((this.partitionColumns == rhs.partitionColumns)||((this.partitionColumns!= null)&&this.partitionColumns.equals(rhs.partitionColumns))))&&((this.dataPath == rhs.dataPath)||((this.dataPath!= null)&&this.dataPath.equals(rhs.dataPath))));
    }
