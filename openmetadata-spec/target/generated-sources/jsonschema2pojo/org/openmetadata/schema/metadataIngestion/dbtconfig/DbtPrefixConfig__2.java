...
public class DbtPrefixConfig__2 {
    ...
    public DbtPrefixConfig__2 withDbtBucketName(String dbtBucketName) {
        this.dbtBucketName = dbtBucketName;
        return this;
    }
    ...
    public DbtPrefixConfig__2 withDbtObjectPrefix(String dbtObjectPrefix) {
        this.dbtObjectPrefix = dbtObjectPrefix;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DbtPrefixConfig__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DbtPrefixConfig__2) == false) {
            return false;
        }
        DbtPrefixConfig__2 rhs = ((DbtPrefixConfig__2) other);
