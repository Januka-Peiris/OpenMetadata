...
public class DbtPrefixConfig {
    ...
    public DbtPrefixConfig withDbtBucketName(String dbtBucketName) {
        this.dbtBucketName = dbtBucketName;
        return this;
    }
    ...
    public DbtPrefixConfig withDbtObjectPrefix(String dbtObjectPrefix) {
        this.dbtObjectPrefix = dbtObjectPrefix;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DbtPrefixConfig.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DbtPrefixConfig) == false) {
            return false;
        }
        DbtPrefixConfig rhs = ((DbtPrefixConfig) other);
